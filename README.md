...
```javascript
Random = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-tools-ternary@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-tools-ternary/tags). For example,

```javascript
Random = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-tools-ternary@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var Random = require( 'path/to/vendor/umd/random-tools-ternary/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-tools-ternary@umd/browser.js"></script>
```
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/random-tools-ternary.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-tools-ternary/main
...
[deno-url]: https://github.com/stdlib-js/random-tools-ternary/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-tools-ternary/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-tools-ternary/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-tools-ternary/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-tools-ternary/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-tools-ternary/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-tools-ternary/blob/main/branches.md
